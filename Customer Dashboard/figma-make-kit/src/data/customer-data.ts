...
export const segmentFilters: Array<CustomerSegment | "All"> = ["All", "Enterprise", "Mid-Market", "SMB"];

export const healthFilters: Array<CustomerHealth | "All"> = ["All", "Healthy", "Needs Attention", "At Risk"];
...
export const overflowSavedViews: SavedView[] = [
  { id: "all", label: "All" },
  { id: "renewals", label: "Renewals", tone: "active", selected: true },
  { id: "expansion", label: "Expansion" },
  { id: "strategic", label: "Strategic" },
...
export const modalSavedViews: SavedView[] = [
...
export const modalOverflowSavedViews: SavedView[] = [
  { id: "quarterly-review", label: "Quarterly review", meta: "Default • 12 accounts", selected: true },
  { id: "renewals-at-risk", label: "Renewals at risk", meta: "5 accounts • shared" },
  { id: "expansion-watchlist", label: "Expansion watchlist", meta: "8 accounts • Mia Chen" },
